...
export default function Contact(){
    ...
    return (
        <>
            ...
            >
                <h1 className="text-6xl text-left font-bold text-gray-800 uppercase dark:bg-clip-text dark:bg-gradient-to-r dark:from-fuchsia-400 dark:to-purple-400 dark:text-transparent">Hit<br/>me<br/>up</h1>
